...
@NamedQueries({
		...
		@NamedQuery(name = "Subscription.findByUserId", query = "select s from Subscription s Join s.order o Join o.user u where u.id=:userId"),
		@NamedQuery(name = "Subscription.findByGeneratedUserId", query = "select s from Subscription s Join s.order o Join o.user u where u.generatedUserId=:generatedUserId"),
		@NamedQuery(name = "Subscription.findByPhone", query = "select s from Subscription s Join s.order o Join o.user u where u.phone=:phone"),
		...
		@NamedQuery(name = "Subscription.findUsersByEndDateAndEndShift", query = "select u from Subscription s Join s.order o Join o.user u where s.endDate=:endDate and s.endShift=:endShift"),
        ...
        @NamedQuery(name = "Subscription.findUserByStatus",  query ="select distinct u from Subscription s join s.order o join o.user u where s.status=:status")                                        		
})
